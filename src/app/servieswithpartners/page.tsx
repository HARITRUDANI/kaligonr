    ...
    <>
      <div id="RdserviceandPartners" className="bg-main w-full h-fit  ">
        ...
        <div className="relative flex ">
          <div className="flex justify-center flex-col items-center gap-6 mt-32  m-20 mb-0 md:m-32   p-0 md:p-11  rounded-[1.375rem] shadow-lg bg-main w-fit h-fit">
            ...
            <div className="grid grid-cols-12  gap-3  items-center justify-center ">
              {rdServices.map((e, i) => (
                <div
                  className="col-span-12 lg:col-span-3 relative h-full"
                  key={i + 1}
                >
                  <div className=" ">
                    ...
                    {i === 3 ? (
                      ...
                      <div className="line hidden lg:block right-0 top-0 lg:absolute">
                        {""}
                      </div>
                    )}
                  </div>
