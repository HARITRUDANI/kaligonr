...
const Partners = (props: Props) => {
  return (
    <>
      <div id="Partners" className="w-full h-fit">
        <div className="w-full bg-main flex flex-col justify-center align-middle items-center pt-32">
          <div className=" flex justify-center flex-col  items-center gap-10 pb-16 md:pb-0 h-fit md:mt-0">
            <div className="absolute">
              <Image
                src="/./assets/Background BG/bg 3.png"
                width={2000}
                height={2000}
          ...
          <div className="flex flex-col gap-32 flex-wrap  md:container h-full margin mt-32 ">
            {parnerDetailes.map((detail, index) => (
              <div key={detail.id} id={detail.id}>
                <div
                  ...
                  } justify-center align-middle gap-10 md:gap-20 items-center mt-0 md:mt-32`}
                  key={index}
                >
                  {detail.imgee && (
                    <Image
        ...
        <div className="bg-main px-2 flex flex-col justify-center align-middle pt-8 pb-2">
