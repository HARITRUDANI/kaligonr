...
export const parnerDetailes = [
  {
    ...
    title: "We Share",
    id: "weShare",
    fp: "We Share, a flourishing network with 50+ offices and 120+ agents nationwide. Thriving independently, profitable, and primed for growth",
    sp: "Kaligon holds a record as a Co-founder and functions as the company’s CTO.",
    tp: "",
    fop: "",
    imgee: "/./assets/Background BG/bg 2.png",
  },
  {
    img: "/./assets/Project image/full images with line/Assisteam.png",
    title: "Assisteam",
    id: "Assisteam",
    fp: "Assisteam leads in artificial intelligence and robotics, specializing in autonomous bot services. At the helm of innovation, we redefine technological boundaries for a smarter future.",
    sp: "Kaligon holds a record as a Co-founder and functions as the company’s CTO.",
    tp: "",
    fop: "",
    imgee: "",
...

  {
    ...
    title: "Jooule cloud",
    id: "Jooulecloud",
    fp: "Kligon partnered with Alsycon on a server farm in the Netherlands and the USA.",
    sp: "From partnership, Jooule was created and provides advanced IT and Cloud services while developing SaaS products.",
    tp: "Kaligon holds a record as a Co-founder and functions as the company’s CTO.",
    fop: "",
    imgee: "",
  },
  {
    img: "/./assets/Project image/full images with line/Roadwarez-graphics.svg",
    title: "Roadwarez",
    id: "Roadwarez",
    fp: "The NYC-based company provides portable-advertising services while developing advanced technology registered as a patent.",
    sp: "The company is in developmental stages.",
    tp: "Kaligon functions as CTO and is in the process of acquiring shares and partnershipsin Roadwarez.",
    fop: "",
    imgee: "/./assets/Background BG/bg 3.png",
  },
  {
    img: "/./assets/Project image/full images with line/Hisky-graphics.svg",
    title: "Hisky",
    id: "Hisky",
    fp: "Develop advanced Satellite Communication Services.",
    sp: "Over the last 3.5 years, Kaligon developed the entire cloud system of hiSky and supported the whole communications flow. ",
    tp: "Kaligon owns options oh hiSky and will convert them to company shares in the future.",
    fop: "According to the last fundraising, hiSky is evaluated in more than 2B USD.",
    imgee: "",
  },
  {
    img: "/./assets/Project image/full images with line/City-Culture-Management-graphics.svg",
    id: "ccm",
    title: "City Culture Management",
    fp: "CCM is a company formed to manage cultural organizations in cities and give a better experience to citizens, municipalities, and cultural organizations.",
    sp: "Kaligon partnered with entrepreneurs from San Francisco and now raising investment from Beer Sheva municipality, which intends to take part and lead the development.",
    tp: "Kaligon functions as CTO and is in the process of acquiring shares and partnerships in CMM.",
    fop: "",
    imgee: "",
  },
];
